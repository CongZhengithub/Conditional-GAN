...
def parse_args():
    ...
    parser.add_argument('--gpu', type=str, default='2', choices=('0', '1', '2','3'), help='gpu name')
    parser.add_argument('--dataset', type=str, default='ADEChallengeData2016', help='dataset_name')
